...
const WatchList1 = () => {
  ...
  const fetchStocks = async () => {
    try {
      const response = await axios.get('https://leveragex-backend.onrender.com/api/watchlist1');
  ...
  const fetchBalance = async () => {
    ...
    try {
      const response = await axios.get(`https://leveragex-backend.onrender.com/api/users/balance/${userId}`);
  ...
  const handleBuy = async () => {
    ...
    try {
      const response = await axios.post('https://leveragex-backend.onrender.com/api/watchlist1/buy', {
